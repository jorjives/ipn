// Colours fenced ```ipn blocks. Rouge has no lexer for IPN, so the blocks arrive as
...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".language-ipn pre code, code.language-ipn, code.ipn").forEach(colour);
