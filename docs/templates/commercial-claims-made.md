...
Copy [`templates/commercial-claims-made.ipn`](https://github.com/jorjives/ipn/blob/main/templates/commercial-claims-made.ipn), rename the product, and replace each
